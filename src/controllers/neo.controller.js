...
const { neoSchema }        = require('./schemas/neo-schema');
...
async function getNeoFeed(req, res){
    ...
    try {
        ...
        const urlManifest         = `${hostname}/neo/rest/v1/feed?api_key=${dataQuery.api_key}&start_date=${dataQuery.start_date}&end_date=${dataQuery.end_date}` ;
